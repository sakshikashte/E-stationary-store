<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginAdminUser.aspx.cs" Inherits="E_Stationary_Store.LoginAdminUser" %>
...
<body>
    ...
    <form id="form1" runat="server">
         <div class="auto-style16">
            <h2 style="text-align:center;color:#F2184F">LOGIN FORM</h2>
             <br />
            ...
            <table class="auto-style6">
                ...
                <tr>
                    ...
                    <td class="auto-style15">
                        <asp:LinkButton ID="lb2" runat="server" BackColor="#F2184F" BorderColor="#000066" Font-Size="30px" ForeColor="#000066" Height="47px" PostBackUrl="~/Login form.aspx" Width="283px" BorderStyle="Solid" CssClass="auto-style17">Login as Customer</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style11" >&nbsp;</td>
               ...
               <tr>
                    ...
                    <td class="auto-style10" style="font-size:20px"> 
                        <asp:LinkButton ID="lb1" runat="server" BackColor="#F2184F" BorderColor="#000066" Font-Size="30px" ForeColor="#000066" Height="46px" PostBackUrl="~/admin login.aspx" Width="283px" BorderStyle="Solid">Login as Admin</asp:LinkButton>
                     </td>
                </tr>
