<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment Mode.aspx.cs" Inherits="E_Stationary_Store.Payment_Mode" %>
...
<body>
			...
			<nav class="navbar navbar-default">
				<div class="container">
					...
					<div class="navbar-header">
						...
						<h1><a href="index.html">Auto Timetable Generator</a></h1>
					</div> 
    ...
    <form id="form2" runat="server">
         <div class="auto-style16">
            ...
            <h2 style="text-align:center;color:#F2184F;">PAY NOW</h2>
             <br />
            ...
            <table class="auto-style6">
                 ...
                 <tr>
                    ...
                    <td class="auto-style10" style="font-size:20px"> 
                        <asp:LinkButton ID="lb1" runat="server"  BorderColor="#0033CC" Font-Size="30px" ForeColor="#F2184F" Height="46px" PostBackUrl="~/Feedback Form.aspx" Width="257px" BackColor="#666699" >Cash On Delivery</asp:LinkButton>
                     </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="auto-style15">
                        <asp:LinkButton ID="lb2" runat="server"  BorderColor="Black" Font-Size="30px" ForeColor="#F2184F" Height="47px" PostBackUrl="~/Payment Details.aspx" Width="257px" BackColor="#666699">Card Payment</asp:LinkButton>
                    </td>
                </tr>
