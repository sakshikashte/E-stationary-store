<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin login.aspx.cs" Inherits="E_Stationary_Store.admin_login" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:Label ID="Label1" runat="server" Text="AdminName:" Font-Size="20px"></asp:Label>
                    </td>
                </tr>
                <tr>
