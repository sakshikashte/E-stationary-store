<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="defualt.aspx.cs" Inherits="E_Stationary_Store.defualt" %>
...
<table>
	<tr>
		<td>
			<h3>You have Product in your cart <asp:Label ID="Label8" runat="server" Text="Label"></asp:Label></h3>
			<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/AddtoCart.aspx">Show cart</asp:HyperLink>
		</td>
	</tr>
</table>
				...
				<table>
					...
					<tr>
						<td class="auto-style1" style="text-align:center; background-color:#F2184F">
							<asp:Label ID="Label5" runat="server" Text="Name:" Font-Bold="true" Font-Names="arial" ForeColor="black" style="text-align:center"></asp:Label>
							<asp:Label ID="Label1" runat="server" Text='<%# Eval("ProductName") %>'  ForeColor="black"></asp:Label>
						</td>
					</tr>
					<tr>
						<td style="text-align:center; background-color:#F2184F">
							<asp:Label ID="Label6" runat="server"  Font-Bold="true" Font-Names="arial" ForeColor="black" style="text-align:center"></asp:Label>
							<asp:Label ID="Label3" runat="server" Text='<%#Eval("ProductDescription") %>' ForeColor="black"></asp:Label>
						</td>
					</tr>
					<tr>
						<td style="text-align:center; background-color:#F2184F">
							...
							<asp:Label ID="Label4" runat="server" Text='<%#Eval("ProductPrice") %>' Font-Bold="true" Font-Names="arial" ForeColor="black" style="text-align:center"></asp:Label>

						</td>
					</tr>
					
					<tr>
						<td align="center" style="background-color: #F2184F; color: #000000; font-weight: bold;">Quantity
					...
					<tr>
						<td style="text-align:center">
							<asp:ImageButton ID="ImageButton1" runat="server" Height="40px" ImageUrl="~/img/add to cart.jpg" Width="160px"
